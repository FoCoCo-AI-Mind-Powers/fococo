...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color performanceChartFill = const Color(0x4CFEA400);  // Transparent orange
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF94A3B8); // Brand-tinted light gray for better harmony
