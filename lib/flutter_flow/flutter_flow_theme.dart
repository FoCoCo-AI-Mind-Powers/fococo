...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0A2A4E);
  late Color secondary = const Color(0xFF3B7F5F);
  late Color tertiary = const Color(0xFFE0A800);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF343A40);
  late Color secondaryText = const Color(0xFF6C757D);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C0A2A4E);
  late Color accent2 = const Color(0x523B7F5F);
  late Color accent3 = const Color(0x4CE0A800);
...
extension TextStyleHelper on TextStyle {
  TextStyle override({
    ...
    double? lineHeight,
    List<Shadow>? shadows,
    String? package, required double height,
  }) {
