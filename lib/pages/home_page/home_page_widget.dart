...
class _HomePageWidgetState extends State<HomePageWidget> {
        ...
        body: StreamBuilder<List<HomeDataRecord>>(
          stream: FirebaseFirestore.instance
              ...
              .map((snapshot) => snapshot.docs
                  .map((doc) => HomeDataRecord.fromSnapshot(doc))
                  .toList()),
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Mental Score Circle
                          _buildMentalScoreSection(homeData, primaryAccent,
                              cardBackground, lightText, mutedText),

                          // Stats Row
                          _buildStatsRow(homeData, cardBackground, lightText,
                              mutedText, primaryAccent, secondaryAccent),

                          // Performance Chart
                          _buildPerformanceChart(homeData, cardBackground,
                              lightText, mutedText, secondaryAccent),

                          // Coach Section
                          _buildCoachSection(homeData, cardBackground,
                              lightText, mutedText, primaryAccent),
                          ...
                          // AI Insights Section
                          _buildAIInsightsSection(homeData, cardBackground,
                              lightText, mutedText, primaryAccent),
  ...
  Widget _buildPerformanceChart(
    ...
    final performanceData =
        data?.performanceData ?? [65, 70, 68, 75, 72, 78, 76];
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              data?.coachMessage ??
                  'Personates your mental game with expert guides travingic',
